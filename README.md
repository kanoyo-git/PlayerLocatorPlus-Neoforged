...
Player Locator Plus NeoForge adds a compass-like multiplayer HUD above the experience bar. It shows the direction of other players in the same dimension, making it easier to find teammates without opening a map or waypoint screen.
